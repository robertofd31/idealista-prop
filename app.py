...
df_properties = df_properties[
    ~df_properties['description'].str.contains(
        'subasta|local sin cambio de uso|cambio de uso|nuda propiedad|no se puede hipotecar|ocupado|ocupada|pujas|ocupacional|ilegal|okupado|sin posesi|procedimiento judicial|alquilado',
        case=False, na=False
    )
]
